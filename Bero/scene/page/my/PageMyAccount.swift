...
struct PageMyAccount: PageView {
            ...
            PageDragingBody(
                ...
                VStack(alignment: .leading, spacing: 0 ){
                    TitleTab(
                        ...
                        title: String.pageTitle.myAccount,
    ...
    private func signout(){
        self.appSceneObserver.sheet = .select(
            String.alert.signOutConfirm,
            String.alert.signOutConfirmText,
...
#if DEBUG
struct PageMyAccount_Previews: PreviewProvider {
    static var previews: some View {
        Form{
            PageMyAccount().contentBody
