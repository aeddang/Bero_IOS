...
struct MyHistorySectionLagercy: PageComponent{
    enum HistoryType{
        case mission, album
    }
    ...
    var body: some View {
        VStack(spacing:0){
            TitleTab(type:.section, title: String.pageTitle.history){_ in }
    ...
    @State var historyType:MyHistorySectionLagercy.HistoryType = .mission
